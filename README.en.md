<div align="center">
  ...
  **🌐 [Try it now at duckmail.local](https://duckmail.local)**
</div>
...
Visit https://duckmail.local/en/api-docs for API documentation and debugging interface.
...
1. Visit https://domain.duckmail.local
...
- Create an [Issue](https://github.com/duckmail/duckmail/issues)
