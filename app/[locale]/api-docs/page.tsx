            ...
            <CardBody>
              ...
              <div className="flex items-center gap-3 bg-default-100 rounded-lg p-3 mb-4">
                <NextCode className="text-sm flex-1 truncate">
                  https://raw.githubusercontent.com/duckmail/duckmail/main/public/llm-api-docs.txt
                </NextCode>
              </div>
              <div className="flex gap-3">
                <Button
                  as="a"
                  href="https://raw.githubusercontent.com/duckmail/duckmail/main/public/llm-api-docs.txt"
                  target="_blank"
          ...
          <Card>
            ...
            <CardBody>
              <p className="mb-2">
                ...
                <NextCode>https://api.duckmail.local</NextCode>
              </p>
            </CardBody>
          </Card>
          ...
          <Card>
            ...
            <CardBody>
              ...
              <div className="flex gap-3">
                <Button
                  as="a"
                  href="https://github.com/duckmail/duckmail"
                  target="_blank"
                  rel="noopener noreferrer"
                  color="primary"
